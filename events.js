...
export const OBJECTIVE_KINDS = [
  ...
  { value: "win_levels", label: "Menang level (sejak join)", unit: "level", hint: "5" },
  { value: "play_levels", label: "Main level win/lose (sejak join)", unit: "level", hint: "10" },
  { value: "total_score", label: "Total score sejak join (bukan lifetime)", unit: "score", hint: "50000" },
  { value: "reach_score_single", label: "Score 1 level sejak join", unit: "score", hint: "30000" },
  { value: "reach_combo", label: "Capai combo sejak join", unit: "combo", hint: "5" },
  { value: "total_matches", label: "Total match sejak join", unit: "match", hint: "100" },
  { value: "complete_objective", label: "Selesaikan in-level objective (sejak join)", unit: "kali", hint: "3" },
  { value: "happy_mood_level", label: "Capai mood happy 1 level (sejak join)", unit: "kali", hint: "1" },
  { value: "match_bomb", label: "Match bomb tile (sejak join)", unit: "kali", hint: "5" },
  { value: "reach_level", label: "Naik N level campaign sejak join", unit: "level", hint: "5" },
  { value: "read_daily_quote", label: "Baca daily quote (sejak join)", unit: "kali", hint: "1" },
  { value: "login_days", label: "Login harian sejak join", unit: "hari", hint: "3" },
  { value: "share_game", label: "Share game (sejak join)", unit: "kali", hint: "1" },
];
